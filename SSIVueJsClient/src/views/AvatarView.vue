...
import ActionBar from "@/components/elements/ActionBar.vue";
import Configurator from "@/components/elements/Configurator.vue";
import DownloadModal from "@/components/Modal/DownloadModal.vue";
import VueColorAvatar, {
  type VueColorAvatarRef,
} from "@/components/elements/VueColorAvatar.vue";

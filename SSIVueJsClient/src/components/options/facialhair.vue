<template>
  <div class="mn">
    ...
    <div @click="showMagnum()">
      <svg viewBox="0 0 100 100">
        <g id="f_magnum">
          <path
            class="tinted"
            fill="#6f2912"
            d="M40 70c7,-1 10,-4 10,-10 0,6 3,9 10,10 10,1 12,-3 20,-3 7,1 8,2 10,2 1,0 1,-1 1,-2 -6,-16 -26,-17 -31,-16 -6,1 -10,4 -10,9 0,-5 -4,-8 -10,-9 -5,-1 -25,0 -31,16 0,1 0,2 1,2 2,0 3,-1 10,-2 8,0 10,4 20,3z"
          />
        </g>
      </svg>
    </div>
      ...
      <svg viewBox="0 0 120 120">
        <g id="f_fancy">
          <path
            class="tinted"
            fill="#6f2912"
            d="M7 70c2,2 18,0 24,-5 6,-5 20,-5 25,-1 2,2 1,5 0,5 -7,4 -15,7 -22,9 -12,4 -21,1 -27,-7 -1,-1 0,-2 0,-1zm106 0c-2,2 -18,0 -24,-5 -6,-5 -20,-5 -25,-1 -2,2 -1,5 0,5 7,4 15,7 22,9 12,4 21,1 27,-7 1,-1 0,-2 0,-1z"
          />
        </g>
      </svg>
    </div>
...
export default {
  ...
  methods: {
    deleteClass() {
      let c = document.getElementById("facialhair2").children,
        i;
    ...
    showMagestic() {
      if (document.querySelector("#f_magestic").classList.contains("show")) {
        this.deleteClass();
      } else {
        this.deleteClass();
        document.querySelector("#f_magestic").classList.add("show");
      }
    },
    showMagnum() {
